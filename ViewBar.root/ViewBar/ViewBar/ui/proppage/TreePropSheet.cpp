...
BOOL CTreePropSheet::OnInitDialog() 
{
	...
	#if _MFC_VER >= 0x0700
	{
		...
		*/
		...
		// the following lines aim to fix a bug [by Charry]
		m_pwndPageTree->ModifyStyleEx(0,       
			WS_EX_CLIENTEDGE);   

		m_pwndPageTree->ShowScrollBar(SB_BOTH);     //   OK   
		m_pwndPageTree->ShowScrollBar(SB_BOTH,FALSE) ;  
