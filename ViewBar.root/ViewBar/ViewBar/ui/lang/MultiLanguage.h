...
// Operations
public:
	static HINSTANCE	LoadLangResourceDLL( LPCTSTR ModuleName, 
		LANGID langUpdateId = MAKELANGID( LANG_NEUTRAL, SUBLANG_NEUTRAL ) );
	static HINSTANCE	LoadResourceDLL( LPCTSTR lpszDllNamePath);
