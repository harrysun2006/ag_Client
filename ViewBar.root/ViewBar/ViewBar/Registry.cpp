...
namespace viewbar
{
	...
	// warning flag
	bool CRegistry::IsWarningFlagExists()
	{
		return IsKeyExists(VB_REG_USER_BASE, VB_REG_PROMPT, true);
	}
	...
	bool CRegistry::GetWarningBeforeQuitFlag()
	{
		return GetBool(VB_REG_USER_BASE, VB_REG_PROMPT, true);
	}
	
	void CRegistry::SetWarningBeforeQuitFlag(bool in)
	{
		SetInt(VB_REG_USER_BASE, VB_REG_PROMPT, in, true);
	}
