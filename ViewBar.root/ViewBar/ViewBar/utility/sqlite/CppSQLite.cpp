////////////////////////////////////////////////////////////////////////////////
// CppSQLite - A C++ wrapper implemention for SQLite embedded database library.
////////////////////////////////////////////////////////////////////////////////

#include "stdafx.h"	// just for vc++.
#include "CppSQLite.h"
#include <cstdlib>

#pragma comment(lib, "utility\\sqlite\\SQLITE.LIB")
...
BOOL CppSQLiteDB::IsExistTable(const char* szTable)
{
	checkDB();
	...
	int nCols(0);
	char selectTable[64];
	sprintf(selectTable,"select %s;",szTable);

	nRet = sqlite_get_table(mpDB, szTable, &paszResults, &nRows, &nCols, &szError);
