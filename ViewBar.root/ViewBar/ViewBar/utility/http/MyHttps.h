...
namespace utility
{
	...
	public:
		...
		BOOL PostFile(TCHAR *pFile, int iFileLen, CString filetype, CString filename, CString strServiceName, CString url, CStringA &response);
		BOOL Get(CString url, CString &response);
