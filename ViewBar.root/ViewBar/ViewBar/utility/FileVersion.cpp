// CFileVersion implementation. 

#include "stdafx.h"
#include "FileVersion.h"

#pragma comment(lib, "version") // link version.lib static library.
...
BOOL CFileVersion::Open(TCHAR *lpszModuleName)
{
    ...
    DWORD dwHandle;     
    DWORD dwDataSize = ::GetFileVersionInfoSize((TCHAR*)lpszModuleName, &dwHandle); 
    if ( dwDataSize == 0 ) 
        return FALSE;

    // Allocate buffer and retrieve version information
    m_lpVersionData = new BYTE[dwDataSize]; 
    if (!::GetFileVersionInfo((TCHAR*)lpszModuleName, dwHandle, dwDataSize, 
...
CString CFileVersion::QueryValue(TCHAR *lpszValueName, 
